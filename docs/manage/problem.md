...
具有新建题目权限的用户可以在题目列表页面的右侧找到「新建题目」板块。点击「新建本地题目」按钮可以新建一个普通题目。点击「新建远端评测题目」可以新建一个由远程 OJ 进行评测的 Remote Judge 题目。新建的题目默认隐藏，题目一经创建**不可删除**。
...
![](https://arina.loli.net/2023/02/14/CVPIf7Oaecoi38l.png)
...
编辑题面页面可以添加标签。如有多个标签请以逗号（中英文均可）隔开。建议写明题目出处、年份、算法等。
